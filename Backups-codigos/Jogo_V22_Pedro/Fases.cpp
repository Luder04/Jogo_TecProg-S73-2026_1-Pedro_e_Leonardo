...
//FASE PRIMEIRA
FasePrimeira::FasePrimeira() : maxInimMedios(4), maxLamas(4) {
...
//FASE SEGUNDA
FaseSegunda::FaseSegunda() : maxChefoes(5), maxLavas(6) {
...
void FaseSegunda::criarProjeteis(Chefao* pChefao) {
    Projetil* pj = new Projetil(x_projetil,y_projetil,pChefao);
