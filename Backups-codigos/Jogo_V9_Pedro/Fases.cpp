...
//FASE ABSTRATA
Fase::Fase() : Ente(), pJog1(NULL), pJogo(NULL), gravidade(1) {
...
void Fase::executar() {
    ...
    //pJog1->desenhar();
    //Desenhar agora é chamado no percorrer de lista_ents
