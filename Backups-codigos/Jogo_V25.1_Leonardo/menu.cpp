...
Menu::Menu() : Ente(), pJog(NULL), submenu_ativo(0), nova_pontuacao(0), mouse_pressionado(false) {
    ...
    criarBotao(0,"NOVO JOGO",[this]() {submenu_ativo=1; return false;} );
        criarBotao(1,"JOGAR FASE 1", [this]() { submenu_ativo=6; return false;} );
            criarBotao(6,"UM JOGADOR", [this]() { pJog->proxFase = 1; pJog->multiplayer=false; return true;} );
            criarBotao(6,"DOIS JOGADORES", [this]() { pJog->proxFase = 1; pJog->multiplayer=true; return true;} );
            criarBotao(6,"VOLTAR", [this]() {submenu_ativo=1; return false;} );

        criarBotao(1,"JOGAR FASE 2", [this]() { submenu_ativo = 7; return false;} );
            criarBotao(7,"UM JOGADOR", [this]() { pJog->proxFase = 2; pJog->multiplayer=false; return true;} );
            criarBotao(7,"DOIS JOGADORES", [this]() { pJog->proxFase = 2; pJog->multiplayer=true; return true;} );
