...
Jogador::Jogador(bool del) : Personagem(), pontos(0), vely(0), velx(0), forca_pulo(16), podePular(true), tempoInvencivel(0.2f) {
	deletarEmJogo = del;
...
//Inimigo facil
Goomba::Goomba() : Inimigo(), raio(5), x_inic(1100), x_atual(x_inic) {
	sizex = 25.0f;
	sizey = 25.0f;
	num_vidas = 1;
	sf::RectangleShape* shape = new sf::RectangleShape(sf::Vector2f(sizex, sizey));
