...
Entidade::Entidade() : Ente(), x(-1), y(-1), sizex(0), sizey(0), buffer(NULL), ehObstaculo(false), deletarEmJogo(false) {
...
const bool Entidade::getDeletarEmJogo() { return deletarEmJogo; }
