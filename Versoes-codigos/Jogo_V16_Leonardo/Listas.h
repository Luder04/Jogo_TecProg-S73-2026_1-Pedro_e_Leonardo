    ...
    public:
        ...
        void limpar() {
            ...
            while (atual != NULL) {
                ...
                if (pInfo != NULL) {
                    if(typeid(*pInfo) != typeid(Jogador)){ //apaga todas as entidades da fase menos o jogador
            ...
            while (pAux != NULL) {
                ...
                if (pEntidade != NULL) {
                    if (pEntidade->getVidas() > 0 ||  pEntidade->getObs() == true ) {
                        ...
                        cout << "Inimigo de Id: " << pEntidade->getId() << " morto e ignorado no desenho...";
